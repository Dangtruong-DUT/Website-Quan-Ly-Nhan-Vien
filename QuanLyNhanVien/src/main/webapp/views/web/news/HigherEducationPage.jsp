...
<body>
    ...
    <div class="container-material container-material--border">
        <div class="material__title text-color--primary container-material--inforE">Đào Tạo Kỹ Sư Công Nghệ Thông Tin</div>
        <div class="material__body">
            ...
            <div class="material__section">
                <div class="section__title text-color--primary">
                ...
                <div class="section__body">
                    ...
                    <p class="section__content">
                        1. Quyết định ban hành Mục tiêu, Chuẩn đầu ra các chương trình đào tạo 180 tín chỉ tích hợp cử nhân - kỹ sư 
                        <a href="" class="link-item">(Tại đây)</a>
                    </p>
                    <p class="section__content">
                        2. Mục tiêu, Chuẩn đầu ra các chương trình đào tạo 180 tín chỉ tích hợp cử nhân - kỹ sư 
                        <a href="" class="link-item">(Tại đây)</a>
                    </p>
                    <p class="section__content">
                        3. Quyết định ban hành mục tiêu, chuẩn đầu ra chương trình đào tạo trình độ đại học hệ chính quy
                        <a href="" class="link-item">(Tại đây)</a>
                    </p>
                    <p class="section__content">
                        4. Mục tiêu và chuẩn đầu ra các chương trình đào tạo trình độ đại học hệ chính quy 
                        <a href="" class="link-item">(Tại đây)</a> 
                    </p>
                    <p class="section__content">
                        5. Quyết định ban hành mục tiêu, chuẩn đầu ra chương trình đào tạo tích hợp chuyên sâu đặc thù hệ chính quy 
                        <a href="" class="link-item">(Tại đây)</a>
                    </p>
                    <p class="section__content">
                        6. Mục tiêu, chuẩn đầu ra chương trình đào tạo tích hợp chuyên sâu đặc thù hệ chính quy 
                       <a href="" class="link-item">(Tại đây)</a> 
                    </p>
                    <p class="section__content">Nhiệm vụ của CTĐT ngành CNTT là cung cấp một nền giáo dục đại học tốt để sinh viên tốt nghiệp có thể thành công trong nghề nghiệp, tiếp tục học sau đại học, và học tập suốt đời. Mục tiêu của CTĐT nhằm cung cấp các kỹ sư chất lượng cao cho thị trường lao động trong nước và quốc tế trong lĩnh vực CNTT. Sinh viên tốt nghiệp: có đạo đức nghề nghiệp tốt; có được kiến ​​thức cơ bản về khoa học tự nhiên và xã hội; nắm vững kiến ​​thức cơ bản và chuyên sâu về CNTT; có kỹ năng mềm, năng lực nghiên cứu và sự sáng tạo để giải quyết các vấn đề trong lĩnh vực CNTT; có trách nhiệm nghề nghiệp, khả năng thích ứng với môi trường làm việc mới, kỹ năng tự học, học tập suốt đời nhằm đáp ứng sự phát triển của khoa học, công nghệ và xã hội.</p>
