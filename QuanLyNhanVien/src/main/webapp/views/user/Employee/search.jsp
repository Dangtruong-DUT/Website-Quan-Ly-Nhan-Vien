	...
	<form action="user" method="post">
		<div class="search__container">
	        ...
	        <div class="search__group-item">
	            ...
	            <div class="search__selectBox-item">
	                <input id="IDPB" type="radio" value="soDienThoai" name="key">
	                <label for="IDPB" class="search__item-label">Số Điện Thoại</label>
	            </div>
	        </div>
	        <div class="search__group-item">
	            <label for="inputField" class="search__item-label">Nhập vào Thông Tin</label>
	            <input id="inputField" class="search__input-field" type="text" name="value" value="">
	        </div>
